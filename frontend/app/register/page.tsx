    ...
    <main className="min-h-screen bg-state-idle flex items-center justify-center px-4 relative overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-sm animate-scale-in">
        <div className="text-center mb-10">
          ...
          <h1 className="text-2xl font-bold text-white mb-2">Begin your mission</h1>
          <p className="text-white/35 text-sm">Set up your AI operating environment.</p>
        </div>

        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            <label className="mono text-xs text-white/30 uppercase tracking-wider block mb-2">Full Name</label>
            <input
